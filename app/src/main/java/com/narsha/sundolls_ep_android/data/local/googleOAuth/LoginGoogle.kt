...
import com.narsha.sundolls_ep_android.data.local.retrofit.LoginRepository

class LoginGoogle(context: Context) {
    private val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
        .requestIdToken("224818744622-p615etko5tejcd585o7l4dh65s5tgcl8.apps.googleusercontent.com")
        .requestServerAuthCode("224818744622-p615etko5tejcd585o7l4dh65s5tgcl8.apps.googleusercontent.com")
        .requestEmail()
        .build()
